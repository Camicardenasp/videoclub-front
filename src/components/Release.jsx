...
const Release =({ release, editTodoItemProp }) => {
    ...
    const [value, setValue]=useState(release); //value is the variable that contains the current state in country and setValue is used to update the state.
    const [tempValue, setTempValue]=useState(release); //tempValue can be used to perform operations on the current value, while setTempValue is used to update the state
...
export default Release; //Export component Release