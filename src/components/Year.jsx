...
const Year =({ year, editTodoItemProp }) => {
    ...
    const [value, setValue]=useState(year); //value is the variable that contains the current state in country and setValue is used to update the state.
    const [tempValue, setTempValue]=useState(year); //tempValue can be used to perform operations on the current value, while setTempValue is used to update the state
...
export default Year; //Export component Year