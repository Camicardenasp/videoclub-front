...
const Language = ({ language, editTodoItemProp }) => {
    ...
    const [value, setValue] = useState(language); //value is the variable that contains the current state in languaje and setValue is used to update the state.
    const [tempValue, setTempValue] = useState(language); //tempValue can be used to perform operations on the current value, while setTempValue is used to update the state
...
export default Language; //Export component Languaje
